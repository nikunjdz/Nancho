...
const links = [
  ...
  { image: face2Img, label: "Excise BIG Personhood,", sublabel: "Neuter Corporate Rulers", href: "#" },
  { image: achilletImg, label: "Reinscribe Corporate Codes,", sublabel: "Re-engineer Big DNA", href: "#" },
  { image: snake3Gif, label: "Remasculate Democracy,", sublabel: "The Big T and Sovereignty", href: "#" },
