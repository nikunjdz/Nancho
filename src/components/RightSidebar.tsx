...
const archives = [
  ...
  { image: truthImg, label: "Truth Emergency", sublabel: "Archive", href: "#" },
  { image: wbaiImg, label: "Ain't that Good News", sublabel: "WBAI Radio Show Archive", href: "#" },
  { image: chautauquaImg, label: "New Chautauqua", sublabel: "Archive", href: "#" },
  { image: karmaImg, label: "Index for Original", sublabel: "Big Karma Site", href: "#" },
  { image: vprezImg, label: "Big Med 2000", sublabel: "V-Prez Campaign", href: "#" },
  { image: memeImg, label: "Meme Works", sublabel: "", href: "#" },
  { image: fdlapImg, label: "Forum of Democratic Leaders", sublabel: "of the Asia-Pacific", href: "#" },
];
  ...
  return (
    ...
    <div className="w-[180px] flex flex-col items-center gap-10 p-4 text-center bg-transparent min-h-screen flex-shrink-0 border-l border-gray-800">
      ...
      <nav className="flex flex-col items-center space-y-10">
        {archives.map((link, i) => (
          <a key={i} href={link.href} className="flex flex-col items-center group no-underline">
